...
class Job(Base):
    ...
    completed_at: Mapped[datetime.datetime | None] = mapped_column(DateTime(timezone=True),default=None)
    current_attempt : Mapped[int] = mapped_column(Integer, default=0, server_default="0")
